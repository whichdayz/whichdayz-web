                ...
                <div className="navbar-end">
                    <div className="navbar-item">
                        <div className="buttons">
                            <Button title='Sign In' className='is-light has-text-weight-bold has-text-centered' color='primary'/>
                            <Button title='Get Started' className='has-text-weight-bold has-text-centered' color='success'/>
                        </div>
                    </div>
                </div>
            </div>
